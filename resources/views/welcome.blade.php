        ...
        <section id="about">
            <div class="container" data-aos="fade-up">
                ...
                <header class="section-header">
                    <h3>Quem Somos</h3>
                    <p>Nesta seção vamos apresentar ao visitante quem somos. O que é a Associação dos ex-alunos do CMS e o que ela pretende.Estou aqui!!!! :)</p>
                </header>
                ...
                <div class="row about-container">
                    ...
                    <div class="col-lg-6 content order-lg-1 order-2">
                        <p>
                            Texto de abertura sobre a Associação, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                        </p>
                ...
                <div class="row about-extra">
                    ...
                    <div class="col-lg-6 pt-5 pt-lg-0" data-aos="fade-left">
                        <h4>Oferecemos apoio e auxílio para os ex-alunos durante o primeiro ano fora do Colégio Militar.</h4>
                        <p>
                ...
                <div class="row about-extra">
                    ...
                    <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-right">
                        <h4>Ser associado custa pouco e garante inúmeras vantagens aos ex-alunos do nosso Cadinho.</h4>
                        <p>
                    ...
                    <div class="col-lg-12 mb-12">
                        <div class="card" data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <img src="{{asset('site/img/apple-touch-icon.png')}}" alt="" width="50">
                                <div class="card-body">
                                    <h5 class="card-title">Uma história de dedicação e lutas</h5>
                                    <p class="card-text">A Associação dos Ex-alunos do Colégio Militar de Salvador foi fundada no dia 17 de Janeiro de 1984, no então auditório do CMS. Na reunião de fundação estavam presentes 53 ex-alunos, que incentivados pelo então Coronel Benito Nino Bisio, comandante do Colégio, tiveram a iniciativa de fundar a Associação que teve como primeiro presidente, Valmar Fontes Hupsel.</p>
