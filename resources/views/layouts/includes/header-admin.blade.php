...
<header id="header" class="fixed-top">
    <div class="container">
        ...
        <nav class="main-nav float-right d-none d-lg-block">
            <ul>
                <li class="active"><a href="{{route('dashboard')}}">Voltar</a></li>
                @if(Auth::user()->role == 1)
                    <li><a href="{{ route('admin.dashboard-admin') }}">Admin</a></li>
                    <li class="drop-down"><a href="#">Conteúdo</a>
                        <ul>
                            ...
                            <li><a href="{{route('admin.photos.index')}}">Fotos</a></li>
                            ...
                            @if( Auth::user()->id == 1 || Auth::user()->id == $dirPres->id)
                                <li><a href="{{route('admin.menspres.index')}}">Mensagens Presi.</a></li>
                            @endif
                        </ul>
                    </li>
                    <li class="drop-down"><a href="#">Funcionalidades</a>
                        <ul>
                            ...
                            <li><a href="{{route('admin.painel')}}">Painel Loja</a></li>
