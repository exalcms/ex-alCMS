                        ...
                        <div class="w-auto p-3">
                            ...
                            <div class="panel-body">
                                <div class="row" style="margin-left: 10px; margin-right: 10px;">
                                    <div class="rol order-esquec" style="margin-bottom: 30px;">
                                        ...
                                        <div style="text-align: right;">Valor Total da Compra: <span>{{$order->total_order}}</span></div>
                                        <div>
                                            {!! Button::primary('Voltar')->asLinkTo(route('logado.nossaloja.cont-compra', ['order' => $order->id])) !!}
                                            {!! Button::primary('Pagar')->asLinkTo(route('admin.users.index')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="section col s12 m6 l6">
                                        ...
                                        <form method="POST" action="{{route('logado.carrinho.update', ['order' => $order->id])}}">
                                            @csrf
                                            @method('PUT')
